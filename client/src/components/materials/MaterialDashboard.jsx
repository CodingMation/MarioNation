...
const MaterialDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 relative pb-16">
                            ...
                            >
                                ...
                                <div className="px-4 py-1">
                                    <div className="flex justify-between items-start mb-2">
                                        <Link
                                            to={`/previewmaterial/${material._id}`}
            ...
            {/* Add Material Button */}
            <Link
                to={`/addmaterial/${exerciseId}`}
                className="fixed bottom-6 right-6 w-14 h-14 bg-purple-600 hover:bg-purple-700 text-white rounded-full flex items-center justify-center shadow-lg z-50 transition-all transform hover:scale-105"
