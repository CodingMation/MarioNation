        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            <p className="text-gray-400">
              Type:{" "}
              <span className="text-white capitalize">{materialInfo.type}</span>
            </p>
            <p className="text-gray-400">
              ID:{" "}
              <span className="text-white font-mono">{materialInfo._id}</span>
            </p>
          </div>
          <div>
            <p className="text-gray-400">
              ...
              <span className="text-white">
                {new Date(materialInfo.updatedAt).toLocaleString()}
              </span>
            </p>
            <p className="text-gray-400">
              Title:{" "}
              <span className="text-white">
                {materialInfo.title || "Untitled"}
              </span>
            </p>
          </div>
        </div>
